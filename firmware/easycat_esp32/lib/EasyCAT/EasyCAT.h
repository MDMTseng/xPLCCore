...
// This library has been tested with Arduino IDE 2.3.4
// https://www.arduino.cc

 
//--- V_2.1 -----
//
// Added function WriteAlias(unsigned short Alias)) to write the alias address from the application
...
#define ALIAS                   0x0012      // Configured Station Alias
...
class EasyCAT 
{
  public:                                       
    ...
    void WriteAlias(unsigned short Alias);  // Write alias address    
...
void EasyCAT::WriteAlias(unsigned short Alias)               // write the alias address to register 0x12

{   
  SPIWriteRegisterIndirect (Alias, ALIAS, 2);              
}
